...
ggsave("figures/Knowledge.tiff", units="in", width=12, height=6, dpi=300, compression = 'lzw')
...
ggsave("figures/attitude.tiff", units="in", width=12, height=6, dpi=300, compression = 'lzw')
...
p3+ theme_pubr()
ggsave("figures/practices.tiff", units="in", width=12, height=6, dpi=300, compression = 'lzw')
